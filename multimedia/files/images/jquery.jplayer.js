	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			...
			noFullWindow: {
				...
				iphone: /iphone/,
				ipod: /ipod/,
				android_pad: /android [0-4]\.(?!.*?mobile)/,
		...
		_init: function() {
			...
			if(this.flash.used) {
				...
				if($.jPlayer.browser.msie && (Number($.jPlayer.browser.version) < 9 || $.jPlayer.browser.documentMode < 9)) {
					var objStr = '<object id="' + this.internal.flash.id + '" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="0" height="0" tabindex="-1" allowFullScreen="true"></object>';
					var paramStr = [
					...
					htmlObj.setAttribute("allowFullScreen", "true");
			...
			if(playing !== undefined) {
				...
				if(this.css.jq.play.length && this.css.jq.pause.length) {
					if(playing) {
						...
						this.css.jq.videoPlay.hide();	// Original for NetCommons
					} else {
						this.css.jq.play.show();
						this.css.jq.pause.hide();
						this.css.jq.videoPlay.show();	// Original for NetCommons
					}
				}
			}
